...
- The format of the dataset is as follows, where, 
    ...
    - each entity is marked by its UMLS UCI (e.g., "D27_B_cells///C1824668") (we just manually create the UCI "C0000000" for "COVID-19"), 
